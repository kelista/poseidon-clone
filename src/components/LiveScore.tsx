    ...
    <View style={styles.LiveScoreContainer}>
      <View style={styles.LiveScoreBodyWrapper}>
          ...
          <View style={styles.LiveScoreBodyTitleWrapper}>
            <View style={[styles.LiveScoreBodyContent, styles.marginRight]}>
              <LinearGradient
                ...
                style={styles.LiveScoreBodyTitle}
              >
              ...
              <View style={styles.LiveScoreBodyContentDetail}>
                {result ? (
                  result.map((d: any, index: number) => {
                    return (
                      <View
                        style={styles.LiveScoreBodyContentDetailRow}
                        key={index}
                      >
                        <Text style={styles.LiveScoreBodyContentDetailRowText}>
                          {d.username}
                        </Text>
                      </View>
                    );
                    ...
                    return (
                      ...
                      >
                        <Text
                          style={
                            d.amount < 0
                              ? styles.LiveScoreBodyContentDetailRowValueRed
                              : styles.LiveScoreBodyContentDetailRowValueGreen
                          }
                        >
        ...
        <View style={styles.LiveScoreBodySpectator}>
          <LinearGradient
            colors={["#6E0000", "#400000"]}
            style={styles.LiveScoreBodySpectatorTitle}
          >
            <Text style={styles.LiveScoreBodySpectatorTitleText}>
              Spectators
            </Text>
          </LinearGradient>
                  ...
                  return (
                    <View style={styles.LiveScoreBodySpectatorContentPlayer}>
                      <Image
                        ...
                        style={styles.LiveScoreBodySpectatorContentPlayerIcon}
                      />
                      <View style={{}}>
                        <Text
                          style={{
