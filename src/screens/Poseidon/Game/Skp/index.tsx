                    ...
                    {!player2 ? (
                      ...
                      <View style={[ThreePic.ThreePicGamePin2, ThreePic.SitTable]}>
                        ...
                        <View style={ThreePic.relative}>
                          ...
                          <View style={{alignItems: "flex-start",zIndex: 5, height: 25.05, marginTop: 42,transform: [{ translateX: -45.1}]}}>
                            <View style={{ flexDirection: "row" }}>
                              <View style={{ flexDirection: "column" }}>
                                <View style={{ width: 17, height: 21, marginTop: 2.2, transform: [{ rotate: "-15deg" }]}}>
                                  {player2C?.cards ? 
                            ...
                            <View style={[ThreePic.ThreePicCardPointDivSkp, {transform: [{ translateX: -3}]}]}>
                              {
                                player2C?.disp? 
                                <View style={{flexDirection:'column'}}>
                    ...
                    {!player3 ? (
                      ...
                      >
                        ...
                        <View style={ThreePic.relative}>
                          ...
                          <View style={{ alignItems: "flex-start", zIndex: 5,height: 25.05, marginTop: 9, transform: [{ translateX: -45.1 }]}}>
                            <View style={{ flexDirection: "row" }}>
                              <View style={{ flexDirection: "column" }}>
                                <View style={{ width: 17, height: 21, marginTop: 2.2, transform: [{ rotate: "-15deg" }]}}>
                                  {player3C?.cards ? 
                    ...
                    {!player4 ? (
                      ...
                      >
                        ...
                        <View style={ThreePic.relative}>
                          ...
                          <View style={{ alignItems: "flex-end", zIndex: 5, height: 25.05, marginTop: -8, transform: [{ translateX: -50.1 - 36}],}}>
                            <View style={{ flexDirection: "row" }}>
                              <View style={{ flexDirection: "column" }}>
                                <View style={{ width: 17, height: 21, marginTop: 2.2, transform: [{ rotate: "-15deg" }]}}>
                                  {player4C?.cards ? 
